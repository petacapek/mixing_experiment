DB_cal_death_pyRS<-function(dataset, py_pars){
  ...
  good<-function(x){
    ...
    R_12Cinit=as.numeric(dataset[1, "Cmic12init"])/(par[["fr"]]+par[["fs"]]/par[["RSinit"]])
    R_13Cinit=as.numeric(dataset[1, "Cmic13init"])/(par[["fr"]]+par[["fs"]]/par[["RSinit"]])
    S_12Cinit=as.numeric(dataset[1, "Cmic12init"])/(par[["fr"]]*par[["RSinit"]]+par[["fs"]])
    S_13Cinit=as.numeric(dataset[1, "Cmic13init"])/(par[["fr"]]*par[["RSinit"]]+par[["fs"]])
  ...
  R_12Cinit=as.numeric(dataset[1, "Cmic12init"])/(py_pars[["fr"]]+py_pars[["fs"]]/py_pars[["RSinit"]])
  R_13Cinit=as.numeric(dataset[1, "Cmic13init"])/(py_pars[["fr"]]+py_pars[["fs"]]/py_pars[["RSinit"]])
  S_12Cinit=as.numeric(dataset[1, "Cmic12init"])/(py_pars[["fr"]]*py_pars[["RSinit"]]+py_pars[["fs"]])
  S_13Cinit=as.numeric(dataset[1, "Cmic13init"])/(py_pars[["fr"]]*py_pars[["RSinit"]]+py_pars[["fs"]])
  G_12Cinit=as.numeric(dataset[1, "G12init"])
  G_13Cinit=as.numeric(dataset[1, "G13init"])
  DOC_12Cinit=as.numeric(dataset[1, "DOC12init"])
  DOC_13Cinit=as.numeric(dataset[1, "DOC13init"])
