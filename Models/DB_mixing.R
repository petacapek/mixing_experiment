DB_mixing<-function(dataset, fractionsPL, fractionsCT, minpar, maxpar){
  ...
  dataset$fr<-with(dataset, Plesne*fractionsPL[["fr"]]+Certovo*fractionsCT[["fr"]])
  dataset$fs<-with(dataset, Plesne*fractionsPL[["fs"]]+Certovo*fractionsCT[["fs"]])
